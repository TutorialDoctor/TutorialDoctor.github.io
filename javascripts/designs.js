...
files.forEach(function(f){
    ...
    designs.innerHTML += `<img onclick="openDesignAlert(this,
        'A bit about this one')" class="hover:border-purple-700 border-4 mx-auto rounded-lg w-64 shadow-lg rounded-lg h-64 object-cover"" data-src="${src}" src="${src}" 
    alt=""
>`
});
console.log(slides)
        ...
        <div class="bg-gray-900 rounded-lg w-full xl:w-1/2 p-8" style="height:auto">
                  <div class="flex flex-col items-start p-4">
                    <div class="flex items-center w-full">
                      <div class="text-2xl text-white my-4">Design</div>
